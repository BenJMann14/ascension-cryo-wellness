        ...
        <div className="p-8">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.button
              ...
              className="bg-gradient-to-br from-blue-500 to-cyan-600 rounded-2xl p-8 text-left text-white shadow-xl hover:shadow-2xl transition-shadow"
            >
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
                <User className="w-8 h-8" />
              </div>
              <h3 className="text-2xl font-black mb-2">Individual Session</h3>

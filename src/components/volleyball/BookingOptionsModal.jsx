        ...
        <div className="p-8">
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.button
              ...
              className="bg-gradient-to-br from-pink-500 to-fuchsia-600 rounded-2xl p-8 text-left text-white shadow-xl hover:shadow-2xl transition-shadow"
            >
              <div className="w-16 h-16 bg-white/20 rounded-2xl flex items-center justify-center mb-4">
                <Users className="w-8 h-8" />
              </div>
              <h3 className="text-2xl font-black mb-2">Team Passes</h3>
            ...
            >
              ...
              <div className="bg-blue-100 text-blue-900 font-bold text-sm px-4 py-2 rounded-lg inline-block">
                Quick & Easy
              </div>
            </motion.button>
          </div>

...
const aestheticServices = [
  ...
  },
  {
    ...
    description: "Targeted cryotherapy to soothe inflammatory skin conditions (acne, eczema, psoriasis) and restore vibrancy to faded tattoos by increasing circulation and reducing inflammation.",
    howItWorks: "Cold therapy reduces inflammation, kills acne-causing bacteria, tightens pores, and increases blood flow to treated areas. For tattoos, enhanced circulation brings oxygen-rich blood to faded ink, helping restore vibrancy.",
    benefits: [
      "Reduced acne and breakouts",
      "Soothed eczema and psoriasis",
      "Decreased skin inflammation",
      "Reduced redness and irritation",
      "Restored tattoo vibrancy",
